...
const projects: Project[] = [
  ...
  },
  {
    ...
    type: "content",
    badge: "BNU",
    title: "X-Ray Lens AI | Automated Pathological Intelligence",
    description: "X-Ray Lens AI is a sophisticated specification engine that transforms standard radiographic imaging into actionable intelligence. Leveraging Antrosys’s custom-trained ML models, the platform instantly highlights, categorizes, and specifies irregularities within X-ray data. Whether you are scaling a telehealth startup or optimizing a high-volume clinic, our headless API integration ensures that world-class diagnostic support is just one click away.",
    imageSrc: "/Images/xray.avif", 
    bgColor: "bg-[#5865F2]",
  ...
  },
  {
    id: 4,
    type: "content",
    badge: "Air University",
    title: "HAUF | Where Computational Photography Meets Community",
    imageSrc: "/Images/hauf.avif",
  ...
  },
  {
    ...
    type: "content",
    badge: "Air University",
    title: "GeoPulse: GPS-Verified Consumer Insights & Geofencing",
    description: "AI-driven geolocation platform allows brands to deploy precision geofences with millimeter accuracy. Leveraging Antrosys’s expertise in marketing automation and growth analytics, GeoPulse tracks GPS-verified conversions, allowing you to trigger personalized mobile experiences the moment a customer enters a high-value zone. It’s a headless, API-first solution designed to bridge the gap between digital intent and physical action, maximizing your ROI through data-backed location intelligence.",
    imageSrc: "/Images/geoloc.avif",
    bgColor: "bg-zinc-900",
  ...
  },
  {
    ...
    type: "content",
    badge: "UZAsquare",
    title: "Unreal Protocol: Dead State",
    imageSrc: "/Images/Zombie.avif",
